...
public class BlockLib {
	...
	public static final String			REFINERY_IDLE		= BLOCK_REFINERY
																+ IDLE;
	public static final String			GRINDER_IDLE		= BLOCK_GRINDER
																+ IDLE;
	...
	private static final String			ORE_PREFIX			= BLOCK_PREFIX
																+ "ore.";

	public static final String			ORE_ARKITE			= ORE_PREFIX
																+ "arkite";
