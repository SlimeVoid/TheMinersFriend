...
public abstract class ContainerMachine extends ContainerBase {
	...
	public void addCraftingToCrafters(ICrafting crafting) {
		...
		if (this.hasProgressBar()) {
			crafting.sendProgressBarUpdate(this, 0, this.getMachineData().cookTime);
			crafting.sendProgressBarUpdate(this, 1, this.getMachineData().burnTime);
			crafting.sendProgressBarUpdate(this, 2, this.getMachineData().currentItemBurnTime);
			crafting.sendProgressBarUpdate(this, 3, this.getMachineData().currentItemCookTime);
		}
	}
	...
	public void detectAndSendChanges() {
		...
		for (int i = 0; i < this.crafters.size(); ++i) {
			...
			if (this.lastCookTime != inventory.cookTime) {
				var2.sendProgressBarUpdate(this, 0, inventory.cookTime);
			}
			
			if (this.lastBurnTime != inventory.burnTime) {
				var2.sendProgressBarUpdate(this, 1, inventory.burnTime);
			}
			
			if (this.lastItemBurnTime != inventory.currentItemBurnTime) {
				var2.sendProgressBarUpdate(this, 2, inventory.currentItemBurnTime);
			}
			
			if (this.lastItemCookTime != inventory.currentItemCookTime) {
				var2.sendProgressBarUpdate(this, 3, inventory.currentItemCookTime);
			}
		}
